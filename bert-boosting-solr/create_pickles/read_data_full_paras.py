...
class squad_para(object):
    ...
    def add_embeddings(self, bc):
      ...
      if bc is not None:
        ...
        self.embedding_list = bc.encode([self.para])
      else:
...
if make_paras_or_questions == 0:
  pickle.dump(para_encodings, open('para_full.pickle','wb'))
elif make_paras_or_questions==1:
  pickle.dump(questions, open('questions_full.pickle','wb'))
else:
  pickle.dump(para_encodings, open('para_full.pickle','wb'))
  pickle.dump(questions, open('questions_full.pickle','wb'))
...
if make_paras_or_questions == 0:
  pickle.dump(para_encodings, open('val_para_full.pickle','wb'))
elif make_paras_or_questions==1:
  pickle.dump(questions, open('val_questions_full.pickle','wb'))
else:
  pickle.dump(para_encodings, open('val_para_full.pickle','wb'))
  pickle.dump(questions, open('val_questions_full.pickle','wb'))
