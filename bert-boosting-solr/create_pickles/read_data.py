...
last_doc_token = ''
counter = 0
(para_encodings, questions) = read_squad_examples('train-v2.0.json', True, True, make_paras_or_questions)

if make_paras_or_questions == 0:
  pickle.dump(para_encodings, open('para_encodings.pickle','wb'))
elif make_paras_or_questions==1:
  pickle.dump(questions, open('squad_questions.pickle','wb'))
else:
  pickle.dump(para_encodings, open('para_encodings.pickle','wb'))
  pickle.dump(questions, open('squad_questions.pickle','wb'))
