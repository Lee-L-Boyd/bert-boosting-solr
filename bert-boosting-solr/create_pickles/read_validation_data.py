...
def read_squad_examples(input_file, is_training, version_2_with_negative, make_paras_or_questions):
    ...
    examples = []
    questions = []
    index = number_of_training_paras - 1
...
last_doc_token = ''
counter = 0
(para_encodings, questions) = read_squad_examples('dev-v2.0.json', True, True, make_paras_or_questions)

if make_paras_or_questions == 0:
  pickle.dump(para_encodings, open('val_para_encodings.pickle','wb'))
elif make_paras_or_questions==1:
  pickle.dump(questions, open('val_squad_questions.pickle','wb'))
else:
  pickle.dump(para_encodings, open('val_para_encodings.pickle','wb'))
  pickle.dump(questions, open('val_squad_questions.pickle','wb'))
