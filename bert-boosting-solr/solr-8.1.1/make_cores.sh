bin/solr start -p 8983 -Dsolr.ltr.enabled=true
bin/solr create -c core_queries
bin/solr create -c core_paras
cp ./solrconfig.xml ./server/solr/core_paras/conf/
bin/post -c core_queries ./delete_all.xml
bin/post -c core_paras ./delete_all.xml
bin/post -c core_paras ./squad_paras.xml
bin/post -c core_queries ./squad_queries.xml
